...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<header id="header">
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function navbar-light">
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Paralakhemundhi</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:naseersonu3@gmail.com">naseersonu3@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+917077469273">+917077469273</a>
								</li>
				...
				<div class="container">
					...
					<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-4">
									...
									<div class="footer-about-us">
										<h5 class="footer-title">About Naseer Jobs</h5>
										<p>Naseer Jobs is a job portal, online job management system </p>
						...
						<div class="col-sm-12 col-md-3 mt-30-sm">
							...
							<h5 class="footer-title">Naseer Jobs Contact</h5>
							
							<p>Address : Paralakhemundhi</p>
							<p>Email : <a href="mailto:naseersonu3@gmail.com">naseersonu3@gmail.com</a></p>
							<p>Phone : <a href="tel:+917077469273">+917077469273</a></p>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Naseer Jobs</p>
						...
						<div class="col-sm-4 col-md-4">
							...
							<ul class="bottom-footer-menu">
								<li><a >Developed by Abdul Naseer</a></li>
							</ul>
